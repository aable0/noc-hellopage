...
export const SliderData = [
    {
        id:1,
        text:"Eğitime yeni bir soluk, başarıya online bir yolculuk...",
        buttontext:"Biz kimiz?",
        buttoncss:"lg:w-96 w-40 text-center font-medium text-[#cbd3f3] border-[#cbd3f3] hover:border-[#7a94f3] hover:text-white hover:bg-[#7a94f3] px-5 py-3 border-2 rounded-full text-xl lg:text-2xl font-light",
        background:"bg-imageid1",
        href:"#BizKimiz",
        slidercss: "w-full lg:w-4/6 flex flex-col justify-center space-y-4 text-2xl lg:text-4xl"
    },
    {
        id:3,
